...
- 🎯 Entry points to execute your program using `python -m <myugpt>` or `$ myugpt` with basic CLI argument parsing.
...
```py
from myugpt import BaseClass
from myugpt import base_function
